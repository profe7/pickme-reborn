...
public class VacancyController {
    ...
    public String detailVacanciesPage(Model model, @PathVariable("mitraId") Long mitraId,
    ...
    public ResponseEntity<TalentAvailableForVacancyResponse> getCompleteTalentListByMitra(
            @PathVariable("mitraId") Long mitraId, @PathVariable("vacancyId") Long vacancyId) {
