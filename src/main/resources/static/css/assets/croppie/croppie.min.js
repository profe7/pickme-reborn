!(function (e, t) {
    ...
    (function (e) {
      ...
      function r(e) {
        ...
        (this._state = null),
          (this._value = null),
          (this._deferreds = []),
          u(e, n(i, this), n(o, this));
      }
      function a(n) {
        var i = this;
        return null === this._state
          ? void this._deferreds.push(n)
          : void c(function () {
        ...
        try {
          ...
          if (e && ("object" == typeof e || "function" == typeof e)) {
            ...
            if ("function" == typeof t)
              return void u(n(t, e), n(i, this), n(o, this));
          }
  ...
  var t = { translate3d: { suffix: ", 0px" }, translate: { suffix: "" } },
    E = function (e, t, n) {
      (this.x = parseFloat(e)),
        (this.y = parseFloat(t)),
  ...
  (E.parse = function (e) {
    return e.style
      ? E.parse(e.style[g])
      : -1 < e.indexOf("matrix") || -1 < e.indexOf("none")
      ? E.fromMatrix(e)
      : E.fromString(e);
  }),
    (E.fromMatrix = function (e) {
      ...
      return (
        ...
        new E(C(t[4]), C(t[5]), parseFloat(t[0]))
      );
    }),
  ...
  function r() {
    ...
    (a.options.useCanvas = a.options.enableOrientation || R.call(a)),
      (a.data = {}),
      (a.elements = {}),
      ...
      x(a.elements.preview, "cr-image"),
      c(a.elements.preview, { alt: "preview", "aria-grabbed": "false" }),
      x(i, "cr-overlay"),
      a.element.appendChild(e),
      e.appendChild(a.elements.preview),
      e.appendChild(n),
      e.appendChild(i),
      x(a.element, "croppie-container"),
      a.options.customClass && x(a.element, a.options.customClass),
      function () {
        var h,
          p,
          d,
        ...
        function v(e, t) {
          var n = f.elements.preview.getBoundingClientRect(),
            i = m.y + t,
            o = m.x + e;
          f.options.enforceBoundary
            ? (l.top > n.top + t && l.bottom < n.bottom + t && (m.y = i),
              l.left > n.left + e && l.right < n.right + e && (m.x = o))
            : ((m.y = i), (m.x = o));
        }
        function i(e) {
          f.elements.preview.setAttribute("aria-grabbed", e),
            f.elements.boundary.setAttribute(
              "aria-dropeffect",
              e ? "move" : "none"
            );
        }
        function e(e) {
          if (
            ...
            i(n),
              ...
              (l = f.elements.viewport.getBoundingClientRect());
          }
        }
        function o(e) {
          e.preventDefault();
          ...
          if ("touchmove" === e.type && 1 < e.touches.length) {
            var s = e.touches[0],
              l = e.touches[1],
              u = Math.sqrt(
                (s.pageX - l.pageX) * (s.pageX - l.pageX) +
                  (s.pageY - l.pageY) * (s.pageY - l.pageY)
              );
        ...
        f.elements.overlay.addEventListener("mousedown", e),
          f.elements.viewport.addEventListener("keydown", function (e) {
            if (!e.shiftKey || (38 !== e.keyCode && 40 !== e.keyCode)) {
              if (
                f.options.enableKeyMovement &&
                37 <= e.keyCode &&
                e.keyCode <= 40
              ) {
                e.preventDefault();
              ...
              (n =
                38 === e.keyCode
                  ? parseFloat(f.elements.zoomer.value) +
                    parseFloat(f.elements.zoomer.step)
                  : parseFloat(f.elements.zoomer.value) -
                    parseFloat(f.elements.zoomer.step)),
                f.setZoom(n);
            }
      ...
      a.options.enableZoom &&
        function () {
          ...
          function o() {
            (function (e) {
              var t = this,
                ...
                i = e
                  ? e.viewportRect
                  : t.elements.viewport.getBoundingClientRect(),
                o = e ? e.origin : new L(t.elements.preview);
              function r() {
                var e = {};
                (e[g] = n.toString()),
                  (e[v] = o.toString()),
                  b(t.elements.preview, e);
              }
              if (
                ((t._currentZoom = e ? e.value : t._currentZoom),
                (n.scale = t._currentZoom),
                t.elements.zoomer.setAttribute("aria-valuenow", t._currentZoom),
                r(),
                ...
                var a = function (e) {
                  ...
                  s = a.translate,
                  l = a.origin;
                n.x >= s.maxX && ((o.x = l.minX), (n.x = s.maxX)),
                  n.x <= s.minX && ((o.x = l.maxX), (n.x = s.minX)),
                  n.y >= s.maxY && ((o.y = l.minY), (n.y = s.maxY)),
                  n.y <= s.minY && ((o.y = l.maxY), (n.y = s.minY));
              }
              r(), I.call(t), F.call(t);
            }).call(i, {
          ...
          function n(e) {
            var t, n;
            if ("ctrl" === i.options.mouseWheelZoom && !0 !== e.ctrlKey)
              return 0;
            (t = e.wheelDelta
              ? e.wheelDelta / 1200
              : e.deltaY
              ...
              ? e.detail / -60
              : 0),
              (n = i._currentZoom + t * i._currentZoom),
              e.preventDefault(),
              B.call(i, n),
              o.call(i);
          }
          x(e, "cr-slider-wrap"),
            ...
            (t.step = "0.0001"),
            (t.value = "1"),
            (t.style.display = i.options.showZoomer ? "" : "none"),
            t.setAttribute("aria-label", "zoom"),
            i.element.appendChild(e),
            e.appendChild(t),
            (i._currentZoom = 1),
            i.elements.zoomer.addEventListener("input", o),
            i.elements.zoomer.addEventListener("change", o),
            i.options.mouseWheelZoom &&
              (i.elements.boundary.addEventListener("mousewheel", n),
              i.elements.boundary.addEventListener("DOMMouseScroll", n));
        }.call(a),
        ...
        function () {
          ...
          x(m, "cr-resizer"),
            ...
            this.options.resizeControls.height &&
              (x((e = document.createElement("div")), "cr-resizer-vertical"),
              m.appendChild(e));
          this.options.resizeControls.width &&
            (x((t = document.createElement("div")), "cr-resizer-horisontal"),
            m.appendChild(t));
          function n(e) {
            if (
              (void 0 === e.button || 0 === e.button) &&
          ...
          function o(e) {
            ...
            var o = t - u,
              ...
              s = d.options.viewport.width + o;
            "v" === l && f <= a && a <= p
              ? (b(m, { height: a + "px" }),
                (d.options.boundary.height += r),
                b(d.elements.boundary, {
                  height: d.options.boundary.height + "px",
                }),
                (d.options.viewport.height += r),
                b(d.elements.viewport, {
              ...
              : "h" === l &&
                ...
                s <= h &&
                (b(m, { width: s + "px" }),
                (d.options.boundary.width += o),
                b(d.elements.boundary, {
                  width: d.options.boundary.width + "px",
                }),
                (d.options.viewport.width += o),
                b(d.elements.viewport, {
  ...
  function X() {
    return (
      0 < this.elements.preview.offsetHeight &&
      0 < this.elements.preview.offsetWidth
    );
  }
  function Y() {
    var e,
    ...
    X.call(t) &&
      ...
      (t.data.orientation = f(t.elements.img)),
      t.options.enableZoom ? W.call(t, !0) : (t._currentZoom = 1),
      ...
      t.data.points.length
        ? function (e) {
            ...
            var t = this,
              ...
              h = {};
            (h[v] = l + "px " + s + "px"),
              (h[g] = new E(c, u, a).toString()),
              b(t.elements.preview, h),
              B.call(t, a),
              (t._currentZoom = a);
          }.call(t, t.data.points)
        : function () {
            var e = this,
  ...
  function W(e) {
    ...
    r.options.enforceBoundary &&
      ...
      (l.max = A(s, 4)),
      !e && (u < l.min || u > l.max)
        ? B.call(r, u < l.min ? l.min : l.max)
        : e &&
          ((n = Math.max(c.width / h.width, c.height / h.height)),
          (t = null !== r.data.boundZoom ? r.data.boundZoom : n),
          B.call(r, t)),
      y(l);
  }
  function O(e) {
    ...
    var h = n,
      ...
      w = c;
    return (
      n < 0 && ((h = 0), (f = (Math.abs(n) / o) * u)),
      d + h > this._originalImageWidth &&
        (g = ((d = this._originalImageWidth - h) / o) * u),
      i < 0 && ((p = 0), (v = (Math.abs(i) / r) * c)),
      m + p > this._originalImageHeight &&
        (w = ((m = this._originalImageHeight - p) / r) * c),
      l.drawImage(this.elements.preview, h, p, d, m, f, v, g, w),
      a &&
        ((l.fillStyle = "#fff"),
  ...
  function k(c, h) {
    var e,
      ...
      t = null,
      n = R.call(p);
    if ("string" == typeof c) (e = c), (c = {});
    else if (Array.isArray(c)) d = c.slice();
    else {
      if (void 0 === c && p.data.url) return Y.call(p), F.call(p), null;
      (e = c.url),
        (d = c.points || []),
        (t = void 0 === c.zoom ? null : c.zoom);
    }
    return (
      (p.data.bound = !1),
      (p.data.url = e || p.data.url),
      (p.data.boundZoom = t),
      ((i = e),
      (o = n),
      (r = new Image()),
      ...
      new Promise(function (e, t) {
        ...
        if (
          ...
          p.options.relative &&
            (d = [
              (d[0] * e.naturalWidth) / 100,
              (d[1] * e.naturalHeight) / 100,
              (d[2] * e.naturalWidth) / 100,
              (d[3] * e.naturalHeight) / 100,
            ]);
        else {
          var t,
            n,
          ...
          p.options.useCanvas &&
            function (e) {
              ...
              t.getContext("2d").clearRect(0, 0, t.width, t.height),
                (t.width = n.width),
                (t.height = n.height),
                _(t, n, (this.options.enableOrientation && e) || f(n));
            }.call(p, c.orientation),
          Y.call(p),
          F.call(p),
          h && h();
      })
  ...
  function n(e) {
    ...
    return (
      "viewport" === r
        ? ((n.outputWidth = c.width), (n.outputHeight = c.height))
        : "object" == typeof r &&
          (r.width && r.height
            ? ((n.outputWidth = r.width), (n.outputHeight = r.height))
            : r.width
            ? ((n.outputWidth = r.width), (n.outputHeight = r.width / h))
            : r.height &&
              ((n.outputWidth = r.height * h), (n.outputHeight = r.height))),
      -1 < N.indexOf(a) && ((n.format = "image/" + a), (n.quality = s)),
      (n.circle = u),
      (n.url = t.data.url),
      (n.backgroundColor = l),
            ...
            e(
              function (e) {
                ...
                return (
                  x(n, "croppie-result"),
                  n.appendChild(i),
                  b(i, { left: -1 * t[0] + "px", top: -1 * t[1] + "px" }),
                  (i.src = e.url),
                  b(n, { width: o + "px", height: r + "px" }),
                  n
                );
              }.call(t, n)
            );
  ...
  function S(e) {
    ...
    (a.data.orientation =
      ...
      (o = i.indexOf(t)),
      (r = (n / 90) % i.length),
      i[(i.length + o + (r % i.length)) % i.length])),
      _(s, a.elements.img, a.data.orientation),
      Z.call(a, !0),
      W.call(a);
  }
  if (window.jQuery) {
  ...
  function T(e, t) {
    if (-1 < e.className.indexOf("croppie-container"))
      throw new Error("Croppie: Can't initialize croppie more than once");
    if (
      ((this.element = e),
      (this.options = p(d(T.defaults), t)),
  ...
  return (
    ...
    (T.globals = { translate: "translate3d" }),
    p(T.prototype, {
      bind: function (e, t) {
        ...
        return function () {
          ...
          n.element.removeChild(n.elements.boundary),
            ...
            n.options.enableZoom &&
              n.element.removeChild(n.elements.zoomerWrap),
            delete n.elements;
        }.call(this);
      },
    }),
